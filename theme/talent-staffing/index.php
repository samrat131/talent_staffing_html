    	...
    	<div class="wrapper-1115">
            <div class="index-body">
                ...
                if (function_exists('get_opt')) {
                    echo get_opt('content_block1', true);
                }
                ?>
    	...
    	<div class="wrapper-1115">
            <div class="index-body2">
            	<div class="experienced">
                    <?php  
                    if (function_exists('get_opt')) {
                        echo get_opt('content_block2', true);
                    }
                    ?>
                ...
                <div class="quality">
                    <?php  
                    if (function_exists('get_opt')) {
                        echo get_opt('content_block3', true);
                    }
                    ?>
                ...
                <div class="lower-fess">
                    <?php  
                    if (function_exists('get_opt')) {
                        echo get_opt('content_block4', true);
                    }
                    ?>
    ...
    <div class="index-body-full3">
    	<div class="wrapper-1115">
            <div class="index-body3">
                <?php  
                if (function_exists('get_opt')) {
                    echo get_opt('content_block5', true);
                }
                ?>
...
<div class="wrapper-1115">
	...
	<div class="index-body4">
        ...
        <?php  
        if (function_exists('get_opt')) {
            echo get_opt('content_block6', true);
        }
        ?>
